...
class BatAdsRefillUnblindedTokensTest : public UnitTestBase {
 protected:
  ...
  URLEndpoints GetRequestSignedTokensUrlRequestEndPoint(
...
TEST_F(BatAdsRefillUnblindedTokensTest,
  ...
  const URLEndpoints endpoints =
      GetRequestSignedTokensUrlRequestEndPoint(net::HTTP_INTERNAL_SERVER_ERROR);
  MockUrlRequest(ads_client_mock_, endpoints);
  ...
  FastForwardClockBy(base::TimeDelta::FromSeconds(15));
...
TEST_F(BatAdsRefillUnblindedTokensTest,
  ...
  // Arrange
  const URLEndpoints endpoints =
      GetRequestSignedTokensUrlRequestEndPoint(net::HTTP_CREATED);
  MockUrlRequest(ads_client_mock_, endpoints);
